...
def parse_args(cmd=None):
    ...
    parser.add_argument('--loss-function', choices=['Dice', 'PixelwiseCrossEntropy'], default='Dice')
    parser.add_argument('--optimizer', choices=['SGD', 'Adam', 'AdamW', 'RMSprop', 'Adagrad'], default='Adam')
    parser.add_argument('--momentum', type=float, default=0.0)
    parser.add_argument('--weight-decay', type=float, default=0.0001)
    parser.add_argument('--augmenttions', nargs='?', default=None, choices=('flip', 'rot90', 'rot270'))
