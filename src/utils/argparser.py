...
def parse_args(cmd=None):
    ...
    parser.add_argument('--dataset-version', default='flip', choices=['single', 'flip', 'all'])
    parser.add_argument('--augmentations', action='store_true')
    parser.add_argument('--project-name', default='semantic-segmentation', help='Weights & biases project name')
    ...
    parser.add_argument('--loss-function', choices=['Dice', 'Tversky', 'IoU', 'PixelwiseCrossEntropy', 'Focal'], default='Dice')
    parser.add_argument('--second-loss-function', choices=['Dice', 'Tversky', 'IoU', 'PixelwiseCrossEntropy', 'Focal', 'None'], default='None')
